const button1 = document.getElementById("add-to-cart-btn19");
const button2 = document.getElementById("add-to-cart-btn20");
const button3 = document.getElementById("add-to-cart-btn21");
const button4 = document.getElementById("add-to-cart-btn22");
const button5 = document.getElementById("add-to-cart-btn23");
const button6 = document.getElementById("add-to-cart-btn24");
