const button1 = document.getElementById("add-to-cart-btn13");
const button2 = document.getElementById("add-to-cart-btn14");
const button3 = document.getElementById("add-to-cart-btn15");
const button4 = document.getElementById("add-to-cart-btn16");
const button5 = document.getElementById("add-to-cart-btn17");
const button6 = document.getElementById("add-to-cart-btn18");
